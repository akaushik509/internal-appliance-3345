...
const Product = () => {
  ...
  // Fiter function of Product Price
  ...
  return (
    <Box>
      <SidebarDrawer RatingChange={RatingChange} PriceChange={PriceChange} />
      <Box
        style={{ display: "flex" }}
        mt={{ base: "0px", md: "120px", lg: "120px" }}
      >
        <Sidebar RatingChange={RatingChange} PriceChange={PriceChange} />
