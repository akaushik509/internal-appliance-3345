...
const steps = [
  ...
  },
  {
    ...
    message:
      "Thanks for letting your Ordering Products issue, Our team will resolve your issue ASAP",
    end: true,
  },
  {
    id: "Want to return a Product",
    message:
      "Thanks for letting your product issue, Our team will help you to return the Product",
    end: true,
  },
];
