import { Divider, Flex, GridItem, Heading, SimpleGrid, Spacer, Stack, Text, VStack,  } from '@chakra-ui/react'
  ...
  return (
    <Flex flexDirection="column" bg="#0d2122" width="100%" padding="15px" height={["2800px","1600px","800px"]} alignItems='center' >
        ...
        <Stack direction={['column','column', 'row']} marginTop={["280px", "100px", "20px"]} >
            <Image src="https://static1.hkrtcdn.com/hknext/static/media/common/footer/pay1.svg" alt="UPI" width="70" height={20}/>
            <Image src="https://static1.hkrtcdn.com/hknext/static/media/common/footer/pay2.svg" alt="VISA" width="70" height={20}/>
            <Image src="https://static1.hkrtcdn.com/hknext/static/media/common/footer/pay3.svg" alt="MAsterCard" width="70" height={20}/>
            <Image src="https://static1.hkrtcdn.com/hknext/static/media/common/footer/pay4.svg" alt="Netbanking" width="70" height={20}/>
            <Image src="https://static1.hkrtcdn.com/hknext/static/media/common/footer/pay5.svg" alt="EMI option" width="70" height={20}/>
            <Image src="https://static1.hkrtcdn.com/hknext/static/media/common/footer/pay6.svg" alt="Cash On Delivery" width="70" height={20}/>
        </Stack>
